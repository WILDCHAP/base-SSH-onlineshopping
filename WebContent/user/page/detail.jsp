...
<div id="shop_detail">
    ...
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" src="../img/goods/<%=book.getIsbn() %>/2.jpg"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
    ...
    <div class="right_detail lf">
        ...
        <div class="shops">
            ...
            <b><img src='../img/product_detail/product_detail_img6<%=request.getAttribute("isCollect") %>.png' alt=""/></b>
        </div>
    </div>
</div>
<!--为你推荐-->
            ...
            <div id="demo1" style="float:left"><!-- 第一个宽度显示 -->
                 <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="http://localhost:8080/fff/user/page/detailBookServlet?isbn=9787302435167"><img src="../img/goods/9787302435167/5.jpg" border="0"></a>
                    </div>
                    <p>Tom Sachs & NikeCraft Mars Yard 2.0宇航员</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="http://localhost:8080/fff/user/page/detailBookServlet?isbn=9787115335500"><img src="../img/goods/9787115335500/5.jpg" border="0"></a>
                    </div>
                    <p>CLOT * Air Jordan 13 Low 兵马俑</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="http://localhost:8080/fff/user/page/detailBookServlet?isbn=9787111213826"><img src="../img/goods/9787111213826/5.jpg" border="0"></a>
                    </div>
                    <p>Yeezy 500 Salt 海盐</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="http://localhost:8080/fff/user/page/detailBookServlet?isbn=9787111545682"><img src="../img/goods/9787111545682/5.jpg" border="0"></a>
                    </div>
                    <p>Yeezy Boost 350 V2 Static 满天星</p>
                </div>
                <!--</div>-->
            </div>
    ...
    <div id="tab">
        <div class="tab lf">
            <div class="cat">
                ...
                <span><a href="../page/lookforward.html">商品评价</a></span>
            </div>
        </div>
        <div class="cart rt">
    ...
    <div class="left lf">
        <div class="all">
            ...
            <div id="parm">
                ...
                <ul>
                    <li><a href="#">商品编号：<%=book.getIsbn() %></a></li>
                    <li><a href="#">商品名称：<%=book.getTitle() %></a></li>
                    <li><a href="#">品牌:<%=book.getAuthor() %></a></li>
                    <li><a href="#">价格：<%=book.getPrice() %></a></li>
                    <li><a href="#">货号：<%=book.getPress() %></a></li>
                    <li><a href="#">发售日期：<%=book.getPublished() %></a></li>
                </ul>
            </div>
...
<script>
    ...
    $(function () {
        ...
        $("#collect").click(function (){
           	...
           	$.ajax({
                type: "post",
                url: '/fff/user/page/collectYesOrNoServlet',
                data: "uid=<%=user.getPhone()%>&isbn=<%=book.getIsbn()%>",//params,
                success: function (data) {
                    if (data == 'yes') {
                    	alert("操作完成！");
                    	window.location.href = "../page/detailBookServlet?isbn=<%=book.getIsbn()%>";
                    } else {
                        alert("操作失败！");
                    }
                },
    ...
    $("#add_cart").click(function (e) {
        ...
        $.ajax({
            type: "post",
            url: '/fff/user/page/addToCartServlet',
            data: params,
            success: function (data) {
                if (data == 'yes') {
                    alert("添加购物车成功！");
                ...
                var url = "../page/detailBookServlet?isbn=<%=book.getIsbn()%>";
                window.location.href = url;
            },
            error: function (data) {
                alert("系统异常！");
