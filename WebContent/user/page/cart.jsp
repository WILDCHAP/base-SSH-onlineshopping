<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@page import="pojo.CartAndBook,pojo.Book,pojo.Cart,java.util.ArrayList" %>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
    <title>stockx商城购物车</title>
...
<%
ArrayList<CartAndBook> list =(ArrayList<CartAndBook>)request.getAttribute("cartAndBook");
...
//			var num=$(this).parent().parent().siblings('.num').children('input').val();
  ...
  console.log(str);
  if(str.length>0){
     var url = '../page/order-confirm.html';//'cartToOrder.action?itemIds='+str;
...
$(function(){
    ...
    $(".add").each(function() {
      $(this).click(function() {
        ...
        $.ajax({
          type: "GET",
          url: "/fff/user/page/updateCartNumServlet",
